...
export const POST_THEMES: Record<PostType, PostTheme[]> = {
  ...
  資產配置: [
    { title: '抗通膨首選', subtitle: '錢會貶值，但精華區土地是財富盾牌' },
    { title: '守護資產力', subtitle: '把資金換成增值資產，這才是穩健獲利' },
    { title: '資產定海神', subtitle: '最好的佈局，是讓資產在好房子裡生利息' },
    { title: '聰明理財術', subtitle: '趁低基期佈局，未來的你會感謝現在的果斷' },
    { title: '財富傳承路', subtitle: '給孩子留現金不如留間房，這是最長情的愛' },
  ],
  土地潛力: [
    { title: '開疆闢土賽', subtitle: '買地不只是買土，是買下被仰望的機會' },
    { title: '投資新座標', subtitle: '三十年土地通福哥，帶你看懂翻身密碼' },
    { title: '地脈淘金術', subtitle: '這片荒地藏著讓你翻身的密碼，看懂就贏' },
    { title: '大地主計畫', subtitle: '土地是不可再生資源，佔位成功就掌握未來' },
    { title: '發財夢起點', subtitle: '在正確的經緯度上，種下你三代的財富夢想' },
  ],
  成家圓夢: [
    { title: '終於有個家', subtitle: '告別搬家漂泊，給家人一個穩定的港灣' },
    { title: '幸福起跑點', subtitle: '這把鑰匙不重，開啟的是後半輩子的笑聲' },
    { title: '圓夢第一站', subtitle: '成家不難，難的是遇到那個懂你溫暖的人' },
    { title: '承諾的重量', subtitle: '買房是對家人最浪漫的告白，讓愛有歸宿' },
    { title: '心靈的堡壘', subtitle: '奮鬥是有意義的，因為背後有座溫暖的家' },
  ],
};
