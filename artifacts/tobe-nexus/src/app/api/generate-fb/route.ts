...
▌押韻規則（韻腳一致，三字各異）：
- 押韻的定義：三行句尾字的「韻腳」（韻母末音）相同即合格，不要求同音、不要求同聲調
- 三個句尾字必須是三個不同的漢字（禁止重複使用同一個字）
- ✅ 正確：「財(cái)、來(lái)、快(kuài)」— 韻腳皆含「-ai」，三字各異 ✓
- ✅ 正確：「旺(wàng)、廣(guǎng)、朗(lǎng)」— 韻腳皆含「-ang」，三字各異 ✓
- ✅ 正確：「利(lì)、地(dì)、意(yì)」— 韻腳皆含「-i」，三字各異 ✓
- ✅ 正確：「財(cái)、帥(shuài)、快(kuài)」— 雖聲調不同，韻腳「-ai」一致 ✓
- ❌ 禁止：「健、健、健」— 三行句尾用同一個漢字
- ❌ 禁止：「穩、穩、穩」— 同樣禁止任何字的重複出現於三行句尾
