...
- 第二行「副標」：延伸標題、帶情緒或誘因，繁體中文，必須達到12–14字（不含標點），字數不足12字即視為違規；必須在語意自然斷點加入全形逗號「，」分成兩段，禁止整行無標點連寫；禁止使用「你的第一間房」「回家」「家人」等住宅語彙來描述商用或土地物件
...
【人設金句生成規則（最後三行）】
- 格式嚴格遵守：每行「XXXXX，XXXXX。」= 五個漢字 + 全形逗號 + 五個漢字 + 句號，共十個漢字
- 三行必須互相呼應，構成完整人設句組
- 可取材以下主題元素（靈活組合，不必全用）：
...
- 依物件類型調整語氣：
  · 商用/店住/辦公：強調專業分析、地段投報、商機布局、精準眼光，語氣沉穩專業
  · 土地/建地/農地：強調開發潛力、增值布局、稀有資產、長遠眼光，語氣權威有力
  · 住宅：可溫柔感性、真誠，融入家庭幸福、安心入住、福氣滿溢等意象
...
（副標，必須12–14字，中間加逗號分兩段，如「XXXXX，XXXXXXX」）
...
=== 珍選好福邸 ===
（人設金句第一行，格式必須是「XXXXX，XXXXX。」共十個漢字加一逗一句號）
（人設金句第二行，格式必須是「XXXXX，XXXXX。」共十個漢字加一逗一句號）
（人設金句第三行，格式必須是「XXXXX，XXXXX。」共十個漢字加一逗一句號）`;
