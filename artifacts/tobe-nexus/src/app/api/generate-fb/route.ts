...
- 第二行「副標」：延伸標題、帶情緒或誘因，繁體中文，必須達到12–14字（不含標點），字數不足12字即視為違規，禁止使用「你的第一間房」「回家」「家人」等住宅語彙來描述商用或土地物件
