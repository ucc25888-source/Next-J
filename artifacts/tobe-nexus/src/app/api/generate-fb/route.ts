...
【地區在地知識 — 融入感言的素材】
根據物件地點「${location}」，主動運用你對花蓮各行政區的知識，挑選最相關的 1-2 個面向融入感言（轉化為體感，禁止條列機能清單）：
- 醫療資源：慈濟醫院、門諾醫院等指標機構的鄰近安心感
- 教育學區：明星國中小、文教環境帶來的居住品質感
- 商圈機能：市場、全聯、連鎖品牌進駐、商業活絡度
- 環境氛圍：綠地、街道、寧靜感或商業活絡感
- 增值潛力：區域稀有性、重大建設、市場走勢
