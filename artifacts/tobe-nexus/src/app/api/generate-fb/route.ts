...
【HOOK 開場段生成規則（2–3句，不是一句）】
- 產出 2 至 3 句話構成的開場段落，每句之間可換行，整段合計約45字（嚴格控制，不超過55字）
- 緊扣「主賣點」與「次賣點」，如有「AI 參考備註」必須融入其中至少一句
- 每一句必須符合以下其中一種氣質（禁止每句都是平淡陳述）：
  · 溫度：喚起畫面感與情感，讓讀者想像自己在這個空間裡
  · 專業：點出別人看不出的優勢、專業判斷、市場洞察
  · 故事：用一個微小場景或人物視角帶出物件最打動人的特點
  · 高 HOOK：開門見山丟出衝擊性結論，製造好奇或驚訝
  · 高情緒價值：讓讀者讀完有感，想繼續往下看
- 依照 HOOK 風格（${hookType}）定調整段語氣
...
· · · · · · · · · · · · · · ·
（HOOK 開場段，2–3句每句換行，整段合計約45字，依 ${hookType} 風格，緊扣主次賣點與AI備註，有溫度／專業／故事／高情緒價值）
· · · · · · · · · · · · · · ·
