        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[9px] font-semibold tracking-tight">{item.label.replace('總覽儀表板', '儀表板').replace('AI 文案生成', 'AI 文案').replace('系統設定', '設定').replace('案件管理', '案件').replace('帶看紀錄', '帶看').replace('買方 CRM', '買方')}</span>
